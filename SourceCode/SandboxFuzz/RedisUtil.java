...
public class RedisUtil {
    ...
    // 生成 Redis 中存储测试用例的键  caseType 文件名称  caseIndex  pre_total_count
    ...
    public List<String> getKeyByPattern(String pattern) {
        ...
        } while (!cursor.equals("0")); // 当游标返回到0时停止
        return keys;
    }
    ...
    public static void classLoader() {
        ...
        List<String> directories = Arrays.asList("/home/admin/lq01145628/internal_release/imemberprod/app", "/home/admin/.m2/repository");
